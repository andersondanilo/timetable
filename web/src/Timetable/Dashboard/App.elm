module Timetable.Dashboard.App where

import Timetable.Dashboard.Types exposing (
  Model,
  Action(ApplyRoute, NavigateTo, HopAction),
  Route(HomeRoute))
import Timetable.Dashboard.Layout.LayoutView exposing (index)
import Timetable.Dashboard.Routes exposing (taggedRouterSignal, routerConfig)
