...
var _user$project$Timetable_Dashboard_Types$Model = function (a) {
	return {currentRoute: a};
};
var _user$project$Timetable_Dashboard_Types$NavigateTo = function (a) {
	return {ctor: 'NavigateTo', _0: a};
};
var _user$project$Timetable_Dashboard_Types$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _user$project$Timetable_Dashboard_Types$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _user$project$Timetable_Dashboard_Types$IndexRoute = {ctor: 'IndexRoute'};

var _user$project$Timetable_Dashboard_Dashboard_View$viewIcon = F2(
	function (name, image) {
		return A2(
			_elm_lang$html$Html$div,
			{
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('col-md-6 text-center'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$Timetable_Dashboard_Dashboard_View$viewDashboard = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Timetable_Common_ViewHelpers$viewTitle('Dashboard'),
			_1: {
				ctor: '::',
				_0: _user$project$Timetable_Common_ViewHelpers$viewContent(
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$Timetable_Dashboard_Dashboard_View$viewIcon, 'Agenda', 'assets/img/icons/clock-icon.png'),
								_1: {
									ctor: '::',
									_0: A2(_user$project$Timetable_Dashboard_Dashboard_View$viewIcon, 'Gerenciar Especialidades', 'assets/img/icons/favourite-2-icon.png'),
									_1: {
										ctor: '::',
										_0: A2(_user$project$Timetable_Dashboard_Dashboard_View$viewIcon, 'Gerenciar Salas', 'assets/img/icons/phonebook-icon.png'),
										_1: {
											ctor: '::',
											_0: A2(_user$project$Timetable_Dashboard_Dashboard_View$viewIcon, 'Gerenciar Profissionais', 'assets/img/icons/contact-icon.png'),
											_1: {
												ctor: '::',
												_0: A2(_user$project$Timetable_Dashboard_Dashboard_View$viewIcon, 'Configurações', 'assets/img/icons/settings-3-icon.png'),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$Timetable_Dashboard_ViewHelpers$clickTo = function (path) {
	return A2(_user$project$Timetable_Common_ViewHelpers$commonClickTo, _user$project$Timetable_Dashboard_Types$NavigateTo, path);
};

var _user$project$Timetable_Dashboard_Views_LayoutView$header = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									A2(
										...
										_user$project$Timetable_Dashboard_ViewHelpers$clickTo('/dashboard')),
									{
										ctor: '::',
...
var _user$project$Timetable_Dashboard_Views_LayoutView$viewCurrentPage = function (model) {
	var _p0 = model.currentRoute;
	if (_p0.ctor === 'IndexRoute') {
		return _user$project$Timetable_Dashboard_Dashboard_View$viewDashboard(model);
	} else {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
...
var _user$project$Timetable_Dashboard_Views_LayoutView$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Timetable_Dashboard_Views_LayoutView$header(model),
			_1: {
				ctor: '::',
				_0: _user$project$Timetable_Dashboard_Views_LayoutView$viewCurrentPage(model),
				_1: {
					ctor: '::',
...
var _user$project$Timetable_Dashboard_Views_LayoutView$css = function (path) {
	return A3(
...
if (typeof _user$project$Timetable_Dashboard_Main$main !== 'undefined') {
    _user$project$Timetable_Dashboard_Main$main(Elm['Timetable']['Dashboard']['Main'], 'Timetable.Dashboard.Main', undefined);
}
