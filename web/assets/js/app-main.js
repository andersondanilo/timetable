...
var _user$project$Timetable_Common_Layout$footerwrap = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$id('footerwrap'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
							...
							},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('hline-w'),
											_1: {ctor: '[]'}
										},
										{ctor: '[]'}),
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Somos um sistema de gerenciamento de horário pronto para atender as necessidades da sua empresa.'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Redes sociais'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
																...
																_0: A2(
																	...
																	},
																	{
																		...
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$class('fa fa-tumblr'),
																				_1: {ctor: '[]'}
																			},
																			{ctor: '[]'}),
																		_1: {ctor: '[]'}
										...
										_1: {
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('contato@xxxxxxx.com.br'),
														_1: {
															ctor: '::',
															_0: A2(
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html$text('(11) XXXX-XXXX'),
																_1: {ctor: '[]'}
															}
														}
													}),
...
var _user$project$Timetable_Common_ViewHelpers$commonClickTo = F2(
...
var _user$project$Timetable_Common_ViewHelpers$viewSectionTitle = function (title) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Timetable_Common_ViewHelpers$viewContent = function (contentBody) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('container mtb'),
			_1: {ctor: '[]'}
		},
		contentBody);
};
var _user$project$Timetable_Common_ViewHelpers$viewTitle = function (title) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Timetable_Frontend_SignupPage_Model$initialModel = {name: '', email: '', password: '', repeatPassword: '', isSending: false};
var _user$project$Timetable_Frontend_SignupPage_Model$Model = F5(
	function (a, b, c, d, e) {
		return {name: a, email: b, password: c, repeatPassword: d, isSending: e};
	});

var _user$project$Timetable_Frontend_LoginPage_Model$initialModel = {username: '', password: ''};
var _user$project$Timetable_Frontend_LoginPage_Model$Model = F2(
	function (a, b) {
		return {username: a, password: b};
	});

var _user$project$Timetable_Frontend_Model$initialModel = function (location) {
	return {
		currentRoute: _user$project$Timetable_Frontend_Common_Router$toRoute(location),
		signupPage: _user$project$Timetable_Frontend_SignupPage_Model$initialModel,
		loginPage: _user$project$Timetable_Frontend_LoginPage_Model$initialModel
	};
};
var _user$project$Timetable_Frontend_Model$Model = F3(
	function (a, b, c) {
		return {currentRoute: a, signupPage: b, loginPage: c};
	});
...
var _user$project$Timetable_Frontend_LoginPage_Update$update = F3(
	function (msg, model, appModel) {
		return {ctor: '_Tuple3', _0: model, _1: appModel, _2: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$Timetable_Frontend_LoginPage_Update$ChangePassword = function (a) {
	return {ctor: 'ChangePassword', _0: a};
};
var _user$project$Timetable_Frontend_LoginPage_Update$ChangeUsername = function (a) {
...
var _user$project$Timetable_Frontend_Common_ViewHelpers$clickTo = function (path) {
	return A2(_user$project$Timetable_Common_ViewHelpers$commonClickTo, _user$project$Timetable_Frontend_Update$NavigateTo, path);
};

var _user$project$Timetable_Frontend_HomePage_View$service = F3(
...
var _user$project$Timetable_Frontend_HomePage_View$services = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$id('service'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A3(_user$project$Timetable_Frontend_HomePage_View$service, 'Gerencie horários', 'clock-o', 'Cadastre o horário de determinado profissional em determinada hora, especialidade e quarto.'),
						_1: {
							ctor: '::',
							_0: A3(_user$project$Timetable_Frontend_HomePage_View$service, 'Gerencie múltiplas agendas', 'calendar', 'Visualize e altere a agenda por profissional, especialidade ou quarto.'),
							_1: {
								ctor: '::',
								_0: A3(_user$project$Timetable_Frontend_HomePage_View$service, 'Integre com outros sistemas', 'link', 'O sistema está aberto para integrações com outros sistemas.'),
								_1: {ctor: '[]'}
							}
						}
					}),
...
var _user$project$Timetable_Frontend_HomePage_View$headerwrap = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('col-lg-8 col-lg-offset-2'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Gerencie o horário de seu hospital ou clínica médica'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Rápido, fácil e intuitivo'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
					...
					_1: {
							...
							},
							{
								...
								_0: A2(
									...
									A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('btn btn-lg btn-theme'),
											_1: {ctor: '[]'}
										},
										_user$project$Timetable_Frontend_Common_ViewHelpers$clickTo('signup')),
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Começe agora'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('col-lg-8 col-lg-offset-2 himg'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$src('assets/img/browser.png'),
											_1: {
												ctor: '::',
...
var _user$project$Timetable_Frontend_HomePage_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Timetable_Frontend_HomePage_View$headerwrap(model),
			_1: {
				ctor: '::',
				_0: _user$project$Timetable_Frontend_HomePage_View$services,
				_1: {ctor: '[]'}
			}
		});
};

var _user$project$Timetable_Frontend_LoginPage_View$formInput = F2(
	function (labelText, nameText) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
...
var _user$project$Timetable_Frontend_LoginPage_View$viewRegisterForm = {
	ctor: '::',
	...
	_1: {
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Se você ainda não possui um cadastro'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
...
var _user$project$Timetable_Frontend_LoginPage_View$viewEnterForm = {
	ctor: '::',
	_0: _user$project$Timetable_Common_ViewHelpers$viewSectionTitle('Entrar'),
	_1: {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$p,
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Se você já está cadastrado, entre através do formulário abaixo'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_user$project$Timetable_Frontend_LoginPage_View$formInput, 'E-mail', 'email'),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Timetable_Frontend_LoginPage_View$formInput, 'Senha', 'senha'),
						_1: {
							ctor: '::',
							_0: A2(
...
var _user$project$Timetable_Frontend_LoginPage_View$view = F2(
	function (model, appModel) {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Timetable_Common_ViewHelpers$viewTitle('Entrar'),
				_1: {
					ctor: '::',
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										_user$project$Timetable_Frontend_LoginPage_View$viewEnterForm),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$div,
											...
											_user$project$Timetable_Frontend_LoginPage_View$viewRegisterForm),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
...
var _user$project$Timetable_Frontend_Main$init = function (location) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Timetable_Frontend_Model$initialModel(location),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _user$project$Timetable_Frontend_Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_user$project$Timetable_Frontend_Update$UrlChange,
	{
		init: _user$project$Timetable_Frontend_Main$init,
		view: _user$project$Timetable_Frontend_View$view,
		update: _user$project$Timetable_Frontend_Update$update,
...
if (typeof _user$project$Timetable_Frontend_Main$main !== 'undefined') {
    _user$project$Timetable_Frontend_Main$main(Elm['Timetable']['Frontend']['Main'], 'Timetable.Frontend.Main', undefined);
}
