...
Elm.Timetable.Common.Layout = Elm.Timetable.Common.Layout || {};
Elm.Timetable.Common.Layout.make = function (_elm) {
   "use strict";
   _elm.Timetable = _elm.Timetable || {};
   _elm.Timetable.Common = _elm.Timetable.Common || {};
   _elm.Timetable.Common.Layout = _elm.Timetable.Common.Layout || {};
   if (_elm.Timetable.Common.Layout.values) return _elm.Timetable.Common.Layout.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   return _elm.Timetable.Common.Layout.values = {_op: _op,footerwrap: footerwrap};
};
Elm.Timetable = Elm.Timetable || {};
Elm.Timetable.Common = Elm.Timetable.Common || {};
...
Elm.Timetable.Common.ViewHelpers.make = function (_elm) {
   ...
   return _elm.Timetable.Common.ViewHelpers.values = {_op: _op,showTitle: showTitle,showContent: showContent,showSectionTitle: showSectionTitle};
};
Elm.Timetable = Elm.Timetable || {};
Elm.Timetable.Frontend = Elm.Timetable.Frontend || {};
Elm.Timetable.Frontend.Types = Elm.Timetable.Frontend.Types || {};
Elm.Timetable.Frontend.Types.make = function (_elm) {
   "use strict";
   _elm.Timetable = _elm.Timetable || {};
   _elm.Timetable.Frontend = _elm.Timetable.Frontend || {};
   _elm.Timetable.Frontend.Types = _elm.Timetable.Frontend.Types || {};
   if (_elm.Timetable.Frontend.Types.values) return _elm.Timetable.Frontend.Types.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Hop$Types = Elm.Hop.Types.make(_elm),
   ...
   return _elm.Timetable.Frontend.Types.values = {_op: _op
                                                 ,HomeRoute: HomeRoute
...
Elm.Timetable.Frontend.Views.IndexView.make = function (_elm) {
   ...
   return _elm.Timetable.Frontend.Views.IndexView.values = {_op: _op,showIndex: showIndex,headerwrap: headerwrap,services: services,service: service};
};
Elm.Timetable = Elm.Timetable || {};
Elm.Timetable.Frontend = Elm.Timetable.Frontend || {};
Elm.Timetable.Frontend.Views = Elm.Timetable.Frontend.Views || {};
...
Elm.Timetable.Frontend.Views.LoginView.make = function (_elm) {
   ...
   var showRegisterForm = _U.list([$Timetable$Common$ViewHelpers.showSectionTitle("Cadastre-se")
                                  ...
                                  _U.list([$Html.text("Começe agora")]))]);
   var showEnterForm = _U.list([$Timetable$Common$ViewHelpers.showSectionTitle("Entrar")
   ...
   _U.list([]),
   _U.list([$Timetable$Common$ViewHelpers.showTitle("Entrar")
...
Elm.Timetable.Frontend = Elm.Timetable.Frontend || {};
Elm.Timetable.Frontend.Views = Elm.Timetable.Frontend.Views || {};
Elm.Timetable.Frontend.Views.SignupView = Elm.Timetable.Frontend.Views.SignupView || {};
Elm.Timetable.Frontend.Views.SignupView.make = function (_elm) {
   "use strict";
   _elm.Timetable = _elm.Timetable || {};
   _elm.Timetable.Frontend = _elm.Timetable.Frontend || {};
   _elm.Timetable.Frontend.Views = _elm.Timetable.Frontend.Views || {};
   _elm.Timetable.Frontend.Views.SignupView = _elm.Timetable.Frontend.Views.SignupView || {};
   if (_elm.Timetable.Frontend.Views.SignupView.values) return _elm.Timetable.Frontend.Views.SignupView.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   _U.list([]),
   _U.list([$Timetable$Common$ViewHelpers.showTitle("Cadastre-se")
           ,$Timetable$Common$ViewHelpers.showContent(_U.list([A2($Html.div,
           _U.list([$Html$Attributes.$class("row")]),
           _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("col-md-6")]),showRegisterForm)]))]))]));
   return _elm.Timetable.Frontend.Views.SignupView.values = {_op: _op,showSignup: showSignup,showRegisterForm: showRegisterForm,formInput: formInput};
};
Elm.Timetable = Elm.Timetable || {};
Elm.Timetable.Frontend = Elm.Timetable.Frontend || {};
Elm.Timetable.Frontend.Views = Elm.Timetable.Frontend.Views || {};
...
Elm.Timetable.Frontend.Views.LayoutView.make = function (_elm) {
   ...
   var showCurrentPage = F2(function (address,model) {
      var _p0 = model.route;
      switch (_p0.ctor)
      {case "HomeRoute": return A2($Timetable$Frontend$Views$IndexView.showIndex,address,model);
         case "SignupRoute": return $Timetable$Frontend$Views$SignupView.showSignup;
         case "LoginRoute": return $Timetable$Frontend$Views$LoginView.showLogin;
   ...
   var index = F2(function (address,model) {
      return A2($Html.div,_U.list([]),_U.list([A2(header,address,model),A2(showCurrentPage,address,model),$Timetable$Common$Layout.footerwrap]));
   });
   return _elm.Timetable.Frontend.Views.LayoutView.values = {_op: _op,index: index,showCurrentPage: showCurrentPage,header: header};
};
Elm.Timetable = Elm.Timetable || {};
Elm.Timetable.Frontend = Elm.Timetable.Frontend || {};
